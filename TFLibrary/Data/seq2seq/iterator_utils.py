...
def get_iterator(src_dataset,
    ...
    if not isinstance(src_dataset, tf.data.TextLineDataset):
        raise TypeError(
            "Expected src_dataset to be tf.data.TextLineDataset, "
            "found ", type(src_dataset).__name__)
    if not isinstance(tgt_dataset, tf.data.TextLineDataset):
        raise TypeError(
            "Expected tgt_dataset to be tf.data.TextLineDataset, "
    ...
    if num_buckets > 1:
        ...
        def key_func(unused_1, unused_2, unused_3, src_len, tgt_len):
            ...
            # Pairs with length over ((num_bucket-1) * bucket_width)
